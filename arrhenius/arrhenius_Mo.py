...
temps = [450, 600, 750, 900]
prop_cycle = plt.rcParams['axes.prop_cycle']
colors = prop_cycle.by_key()['color']

k, kerr = plot_rxn_over_time(start, time_per_frame_ps, axs[1], temps = temps, rxns = ["H-H_Mo.True.com.npy", "H-H_Mo.True.dis.npy"], linestyles = ["solid", "dotted"])

print(k[0])
print(k[1])

plot_arrhenius(k[0], kerr[0], temps, axs[2], colors, "solid", "o")
