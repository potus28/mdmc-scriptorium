...
beta_one_over_kJ = 1.0 / (kB_kJperK * temp_K)

box1_energies = np.load(f"../{prefix}.out.box1.prp.Energy_Total.npy")
box2_energies = np.load(f"../{prefix}.out.box2.prp.Energy_Total.npy")

box1_volumes = np.load(f"../{prefix}.out.box1.prp.Energy_Total.npy")
box2_volumes = np.load(f"../{prefix}.out.box2.prp.Energy_Total.npy")

nframes = len(box1_energies)

box1_energies = box1_energies[nframes//2:]
box2_energies = box2_energies[nframes//2:]
box1_volumes = box1_volumes[nframes//2:]
box2_volumes = box2_volumes[nframes//2:]

box1_plus_box2_energy = box1_energies + box2_energies
box1_plus_box2_energy *= -beta_one_over_kJpermol


m3bar_to_kJ = 100.0
ang3_to_m3 = 1E-30

box1_mechanical = box1_volumes * pressure_bar * m3bar_to_kJ * ang3_to_m3
box2_mechanical = box2_volumes * pressure_bar * m3bar_to_kJ * ang3_to_m3

box1_plus_box2_mechanical = box1_mechanical + box2_mechanical
box1_plus_box2_mechanical *= -beta_one_over_kJ

box1_plus_box2 = box1_plus_box2_energy + box1_plus_box2_mechanical
